...
f3 = Frame(f)
sc = StringVar()
Label(f3, text="Generate Password:",font="comicsans 14").pack(side=LEFT)
...
b = Button(text="GENERATE PASSWORD", font="comicsans 14 bold",bg="purple", fg="white",borderwidth=3, command=passwd_generator)
b.pack()

b2 = Button(text="ACCEPT", font="comicsans 14",bg="white",fg="purple", borderwidth=3)
b2.pack(pady=20)

b3= Button(text="REJECT", font="comicsans 14",bg="white",fg="purple", borderwidth=3)
b3.pack()
